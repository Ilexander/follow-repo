<div class="trueToggle">
  <?php
  foreach ($items as $key => $item_category) {
  ?>
    <div class="col-md-12 col-xl-12">
      <div class="card">
        <div class="card-header card-header--toggle pt-5">
          <h3 class="card-title"><span class="services__projects--icon me-3 _icon-<?php echo $key; ?>"></span> <?php echo $key; ?></h3>
            ...
            <tbody>
              ...
              ?>
                  <tr class="tr_<?php echo esc($item['id']); ?>">
                    <td class="text-center text-muted table_id"><?= esc($item['id']); ?></td>
                    <td class="table_name">
                      <div class="title"><?= esc($item['name']); ?></div>
                    </td>
                    <td class="table_price w-5p">
                      <div><?= $item_price; ?></div>
                    </td>
                    <td class="text-center w-10p text-muted"><?= $item['min'] . ' / ' . $item['max'] ?></td>
                    <td class="text-center"> <?php echo $show_item_view; ?></td>
                  </tr>
              <?php }
              } ?>
            </tbody>
