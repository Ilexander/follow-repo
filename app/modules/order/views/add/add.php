...
?>
<div class="new__order">
  <div class="row justify-content-md-center justify-content-xl-center" id="result_ajaxSearch">
    <div class="w-100">
      <div class="card">
        <div class="card-header d-flex align-items-center justify-content-center pt-5 pl-xl-5 new__order-header">
          <h2 class="new-order__title _title ps-2 ps-sm-4 pl-xl-5">
            New order
          </h2>
          <div class="tabs-list ml-auto">
            <ul class="nav nav-tabs">
              <li class="">
                <a class="active show" data-toggle="tab" href="#new_order"> <?= lang("single_order") ?></a>
              </li>
              <li>
                <a data-toggle="tab" href="#mass_order"> <?= lang("mass_order") ?></a>
              </li>
            </ul>
          </div>
        </div>
          ...
          <div class="tab-content">
            <div id="new_order" class="tab-pane fade in active show">
              <form class="form actionForm" action="<?= cn($controller_name . "/ajax_add_order") ?>" data-redirect="<?= cn('new_order') ?>" method="POST">
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <div class="row d-none">
                      <div class="col-md-4  col-sm-12 col-xs-12">
                        <div class="form-group">
                          ...
                          <button class="clear__area" type="button">&times;</button>
                        </div>
                      </div>
                    ...
                    <div class="form-group order-default-quantity">
                      ...
                      <input class="form-control square ajaxQuantity" name="quantity" type="text">
                      <button class="clear__area" type="button">&times;</button>
                    </div>
                    ...
                    <div class="row" id="result_onChangeService">
                      ...
                      <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="form-group">
                          ...
                          <textarea rows="6" name="service_desc" class="form-control square" readonly>
                        </textarea>
                          <button class="clear__area" type="button">&times;</button>
                        </div>
                      </div>
                ...
                <div class="form-group d-flex align-items-center new__order-bottom">
                  <div class="form-group mb-0" id="result_total_charge">
                    <input type="hidden" name="total_charge" value="0.00">
                    <input type="hidden" name="currency_symbol" value="<?= get_option("currency_symbol", "") ?>">
                    <p class="btn btn-info total_charge mb-0"><?= lang("total_charge") ?> <span class="charge_number">$0</span></p>
                  ...
                  <label class="custom-control custom-checkbox mt-0 mb-0">
                    <input type="checkbox" class="custom-control-input" name="agree">
                    <span class="custom-control-label new__order-confirm"><?= lang("yes_i_have_confirmed_the_order") ?></span>
                  </label>
                  <div class="form-actions left ml-auto">
                    <button type="submit" id="single_button" class="btn btn-primary _large-btn btn-min-width mr-1" onclick="makeOrder()">
                      <?= lang("place_order") ?>
                    </button>
                  </div>
                </div>
              ...
              <form class="form actionForm" action="<?= cn($controller_name . "/ajax_mass_order") ?>" data-redirect="<?= cn($controller_name . "/log") ?>" method="POST">
                <div class="x_content row">
                  <div class="w-100">
                    ...
                    <div class="mass__inner">
                      <div class="mass__wrapper">
                        <div class="form-group">
                          <label><?= lang("link") ?></label>
                          <input class="form-control square" name="service_min" type="text" value="" readonly>
                          <button class="clear__area" type="button">&times;</button>
                      ...
                      <div class="form-group">
                        ...
                        <textarea id="editor" rows="11" name="mass_order" class="form-control square" placeholder="service_id|quantity|link"></textarea>
                        <button class="clear__area" type="button">&times;</button>
                      </div>
                    </div>
                    <div class="form-group">
                      <h6 class="new__order-note"> <?= lang("note") ?></h6>
                      <p class="new__order-desc">
                    ...
                    <div class="mass__bottom">
                      ...
                      <div class="form-actions left ml-auto">
                        <button type="submit" id="mass_button" class="btn round btn-primary _large-btn btn-min-width mr-1 mb-1" onclick="makeOrder()">
                          <?= lang("place_order") ?>
                        </button>
                      </div>
                    </div>
...
<script>
  function makeOrder() {
    setTimeout(function() {
      $('#single_button').prop('disabled', true);
      $('#mass_button').prop('disabled', true);
    }, 1000);
  }
