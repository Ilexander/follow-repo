        ...
        <div class="tab-content">
              ...
              <div class="row">
                <div class="col-md-6">
                  ...
                  <div class="form-actions left">
                    <button type="submit" id="single_button" class="btn btn-primary btn-min-width mr-1 mb-1" onclick="makeOrder()">
                      <?=lang("place_order")?>
                    </button>
          ...
          <div id="mass_order" class="tab-pane fade">
            <form class="form actionForm" action="<?=cn($controller_name."/ajax_mass_order")?>" data-redirect="<?=cn($controller_name."/log")?>" method="POST">
              ...
              <div class="form-actions left">
                <button type="submit" id="mass_button" class="btn round btn-primary btn-min-width mr-1 mb-1"  onclick="makeOrder()">
                  <?=lang("place_order")?>
                </button>
              </div>
            </form>
