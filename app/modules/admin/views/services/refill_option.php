  ...
  <div class="form-group service-refill">
    <div class="form-label">Refill
      <label class="custom-switch">
        ...
        <input type="checkbox" name="refill" id='refill-option' class="custom-switch-input" data-toggle="collapse" data-target="#refill-from" aria-expanded="false" aria-controls="refill" value="1" <?php echo ($item['refill']) ? 'checked' : '' ?>>
        <span class="custom-switch-indicator"></span>
      </label>
    </div>
  </div>
</div>
<div class="col-md-12 collapse <?php echo ($item['refill']) ? 'show' : '' ?>" id="refill-from">
  <div class="form-group">
    ...
    <select name="refill_type" class="form-control square refill-type-option">
      <option value="0" <?php echo (!$item['refill']) ? 'selected' : '' ?> class='refill-manual'> Manual </option>
      <?php if($item['refill']) {?>          
      <option value="1" <?php echo ($item['refill_type']) ? 'selected' : '' ?> class='refill-provider'> Provider </option>
      <?php }?>
    </select>
  </div>
</div>
