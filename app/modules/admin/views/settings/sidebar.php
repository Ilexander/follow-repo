<?php
  ...
  <div class="list-group list-group-transparent mb-0">
            <label class="custom-switch">
                ...
                <input type="checkbox" onclick="changeSupportStatus()" '.(($support_status == 1) ? "checked" : "").' class="custom-switch-input"  value="1">
                <span class="custom-switch-indicator"></span>
                <span class="custom-switch-description">Support status</span>
            </label>
        </div>';
  $i = 0;
