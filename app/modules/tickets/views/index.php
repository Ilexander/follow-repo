...
<!--        &nbsp;--><?//=lang("Tickets")?>
          <?php
          if($supportOnline) {
              echo "<p>".lang("Tickets")." / Support <span style='color: green'> online</span></p>";
          } else {
              echo "<p>".lang("Tickets")." / Support <span style='color: red'>offline</span>, time left <span style='color: green'>".(round($timeLeft / 100))."H:".($timeLeft % 100)."m</span></p>";
          }
          ?>
      </h1>
    </div>
